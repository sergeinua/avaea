...
avaeaStandaloneApp.controller('searchAirController',
  ['$scope', '$state', '$timeout', '$mdDialog',
    'SearchAirService', 'localStorageService',
    SearchAirController]);

function SearchAirController($scope, $state, $timeout, $mdDialog, SearchAirService, localStorageService) {
              ...
              function ($scope, $mdDialog) {
                  ...
                  $scope.answer = function (answer) {
                      if (!answer) {
                        ...
                        var _flight = localStorageService.get('flight');
                        if (!_flight) {
                          _flight = [{flight: flight, price: $scope.price}];
                        } else {
                          _flight.push({flight: flight, price: $scope.price});
                        }

                        localStorageService.set('flight', _flight);
                        $state.go('home.bookingCart');
