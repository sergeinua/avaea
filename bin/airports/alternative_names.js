...
AlternativeNames.prototype.run = function( asyncsCounter ) {
  // Convert the structure of _ALTERNATIVE_NAMES to work around the shorthand notation above
  let airports = {};
  for( let iata_3code in _ALTERNATIVE_NAMES ) {
    airports[iata_3code] = {
      'source'           : 'alternative_names',
      'iata_3code'       : iata_3code,
      'alternative_name' : _ALTERNATIVE_NAMES[iata_3code]
    }
  }
