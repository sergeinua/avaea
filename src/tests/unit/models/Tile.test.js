  ...
  describe('#getTilesDataAlternative()', function () {
    ...
    it('should check smartRanknig', function (done) {
      Tile.getTilesDataAlternative(itineraries, params, function (err, itineraries, tileArr) {
        ...
        itineraries[ 3].smartRank.should.be.eql( 1);
        itineraries[ 4].smartRank.should.be.eql( 3);
        itineraries[ 5].smartRank.should.be.eql( 4);
        itineraries[ 6].smartRank.should.be.eql( 5);
        itineraries[ 7].smartRank.should.be.eql( 6);
        itineraries[ 8].smartRank.should.be.eql( 7);
        itineraries[ 9].smartRank.should.be.eql( 8);
        itineraries[10].smartRank.should.be.eql( 9);
        itineraries[11].smartRank.should.be.eql(11);
        itineraries[12].smartRank.should.be.eql(12);
        itineraries[13].smartRank.should.be.eql(13);
        itineraries[14].smartRank.should.be.eql(14);
        itineraries[15].smartRank.should.be.eql(16);
        itineraries[16].smartRank.should.be.eql(17);
        itineraries[17].smartRank.should.be.eql(18);
        itineraries[18].smartRank.should.be.eql(19);
        itineraries[19].smartRank.should.be.eql(20);
        itineraries[20].smartRank.should.be.eql(22);
        itineraries[21].smartRank.should.be.eql(24);
        itineraries[22].smartRank.should.be.eql(25);
        itineraries[23].smartRank.should.be.eql(15);
        itineraries[24].smartRank.should.be.eql(23);
        itineraries[25].smartRank.should.be.eql(26);
        itineraries[26].smartRank.should.be.eql(27);
        itineraries[27].smartRank.should.be.eql(28);
        itineraries[28].smartRank.should.be.eql(29);
        itineraries[29].smartRank.should.be.eql(30);
