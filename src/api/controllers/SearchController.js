...
module.exports = {
  ...
  result: function (req, res) {
    ...
    var
      ...
      Search.getResult(uid, params, function(found) {
      ...
      // .then(
      //   function (found) {
      //     var tiles = Tile.getTilesData(found).then();
      //     return [found, tiles];
      //   }
      // )
      // .spread(function (itineraries, tiles) {
      //   sails.log(tiles);
      //   return  res.view('search/result', {
  ...
  //   async.waterfall([
  //     async.constant(uid, req),
  //     function (callback, uid , req) {
  //       var
  //         params = {
  //           DepartureLocationCode: req.param('originAirport').toUpperCase(),
  //           ArrivalLocationCode: req.param('destinationAirport').toUpperCase(),
