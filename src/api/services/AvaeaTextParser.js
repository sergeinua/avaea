...
// module globals
/////////////////////////////////////////////////////////////////
const _PARSER = new AvaeaTextParser();
...
module.exports = {
	...
	var err, result;
	try {
	    var not_parsed = _PARSER.run(text);
	    result = {
		query               : text,
		not_parsed          : not_parsed,
		action              : 'form',      // 'top', 'all' // TODO: is not recognized yet
		airline             : undefined,   // TODO: is not recognized yet
		origin_airport      : _PARSER.origin_airport     ? _PARSER.origin_airport.value     : undefined,
		destination_airport : _PARSER.return_airport     ? _PARSER.return_airport.value     : undefined,
		origin_date         : _PARSER.origin_date        ? _PARSER.origin_date.value        : false,
		return_date         : _PARSER.return_date        ? _PARSER.return_date.value        : false,
		type                : _PARSER.type               ? _PARSER.type                     : undefined,
		number_of_tickets   : _PARSER.number_of_tickets  ? _PARSER.number_of_tickets.value  : undefined,
		class_of_service    : _PARSER.class_of_service   ? _PARSER.class_of_service.value   : undefined
	    };
	} catch (e) {
	    err = e;
	}
